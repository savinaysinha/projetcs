...
/**
 * Servlet implementation class UpdateTrainingController
 */
@WebServlet("/UpdateTrainingController")
public class UpdateTrainingController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("UserDashboardController?msg=Successfully Updated");
